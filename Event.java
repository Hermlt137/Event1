...
public class Event {  
    ...
    public Event(String eventID, String eventName, String eventVenue, String eventDate,String gender,String email) throws ParseException {  
    ...
    public static void main(String[] args) {  
        ...
        try {  
            ...
            Event event = new Event(eventID, eventName, eventVenue, eventDate,email,gender);
            while (true) {  
